...
$packages["math"] = (function() {
	var $pkg = {}, $init, js, bits, arrayType, arrayType$1, arrayType$2, structType, math, buf, init, Float64bits, Float64frombits, Abs;
	js = $packages["github.com/gopherjs/gopherjs/js"];
...
$packages["main"] = (function() {
	var $pkg = {}, $init, js, math, funcType, mapType, main, bruteForceCalculate;
	js = $packages["github.com/gopherjs/gopherjs/js"];
	math = $packages["math"];
	funcType = $funcType([$Float64, $Float64, $Float64, $Float64, $Float64, $Float64], [$Float64, $Float64, $Float64], false);
	mapType = $mapType($String, $emptyInterface);
	main = function() {
		$global.fuelratio = $externalize($makeMap($String.keyFor, [{ k: "bruteForceCalculate", v: new funcType(bruteForceCalculate) }]), mapType);
	};
	bruteForceCalculate = function(Wc, Fc, Wt, Ft, W1, W2) {
		var Fc, Ft, W1, W2, Wc, Wt, _tmp, _tmp$1, _tmp$2, _tmp$3, _tmp$4, _tmp$5, _tmp$6, _tmp$7, _tmp$8, f1, f2, fuel1, fuel2, i, ratio, resultRatio;
		fuel1 = 0;
		fuel2 = 0;
		resultRatio = 0;
		if (Fc > Ft) {
